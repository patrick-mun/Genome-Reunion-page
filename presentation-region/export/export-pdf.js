/* export-pdf.js — Génome Réunion · Présentation Région Réunion
...
const PORT = 8933;
const OUT_PATH = path.resolve(process.argv[2] || path.join(__dirname, 'Presentation_Region_Reunion.pdf'));
